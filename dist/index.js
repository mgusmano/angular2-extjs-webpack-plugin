...
Angular2ExtJSWebpackPlugin.prototype.apply = function (compiler) {
	...
	//c.plugin('compile',function(){y('\n***** compile')});
	//c.plugin('after-compile',function(compiler,cb){y('\n***** after-compile');cb();});
	c.plugin('done', function (stats) {
		y('\n***** done');
	});
	//c.plugin('after-plugins',function(){y('\n***** after-plugins')});
	...
	// 	// compilation.plugin('after-compile', function(loaderContext, module) {
	// 	// 	console.log(chalk.yellow('\n***** after-compile'));
	// 	// });
	...
	compiler.plugin('compilation', function (compilation, params) {
		...
		compilation.plugin("xoptimize", function () {
	...
	compiler.plugin('emit', function (compilation, cb) {
		...
		try {
			for (var _iterator3 = uniqueDependencies[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
